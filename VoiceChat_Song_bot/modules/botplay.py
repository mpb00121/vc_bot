...
from VoiceChat_Song_bot.helpers.filters import other_filters
from VoiceChat_Song_bot.helpers.gets import get_file_name
from VoiceChat_Song_bot.services.callsmusic import callsmusic
...
async def generate_cover(requested_by, title, views, duration, thumbnail):
    ...
    image2 = Image.open("./PicsArt_10-02-05.45.42.png")
...
async def play(_, message: Message):
    ...
    if message.chat.id in DISABLED_GROUPS:
        return    
    lel = await message.reply("✳️ Pʀᴏᴄᴇssɪɴɢ ᴛᴏ Pʟᴀʏ")
    ...
    try:
        ...
        return
    text_links=None
    await lel.edit("🔎 Sᴇᴀʀᴄʜɪɴɢ Sᴏɴɢ ᴏɴ Yᴏᴜᴛᴜʙᴇ")
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://te.legra.ph/file/968c2b4dbb5b059e5acfb.jpg"
        ...
        query = toxt
        await lel.edit("🎵 Sᴛᴀʀᴛɪɴɢ ᴛᴏ Pʟᴀʏ")
        ...
        try:
            toxxt = "```Please Select your Song(Requested user only Allowed!)```\n\n"
            j = 0
            useer=user_name
            emojilist = ["🍓","🍒","🍎","🍉","🍊"]
